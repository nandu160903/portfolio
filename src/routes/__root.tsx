    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <div className="mt-6">
          <Link
            to="/"
            className="inline-flex items-center justify-center rounded-md bg-accent px-4 py-2 text-sm font-bold text-background transition-colors hover:opacity-90"
          >
            Return to base
          </Link>
        </div>
...
const title = "Nandan S — AI Engineer & Full-Stack Developer";
const description =
  "Portfolio of Nandan S — building intelligent systems at the intersection of Generative AI, computer vision, and modern full-stack architecture.";
